...
scores = json.loads((S / "poc_scores.json").read_text())
mapping = json.loads((S / "poc_unblinding.json").read_text())
cases = {c["case_id"]: c for c in json.loads((S / "poc_cases.json").read_text())["cases"]}
